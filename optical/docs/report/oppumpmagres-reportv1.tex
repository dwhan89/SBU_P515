...
D. Han wrote the ``Experimental Set-Up" and ``Theoretical Model" sections, while K. Wood wrote the ``Introduction", ``Measurements", and ``Discussion and Conclusions" sections.
