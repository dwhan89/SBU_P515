...
with open("../data/MagMomMeas-Rb85.txt",newline='') as csvfile:
...
plt.plot(x85,linear(x85,*popt85),label='$^{85}$Rb fit')
...
with open("../data/MagMomMeas-Rb87.txt",newline='') as csvfile:
     reader = csv.reader(csvfile, delimiter="	")
     for row in reader:
